...
namespace BruTile.MbTiles.Tests
{
    ...
    public class MbTilesTileSourceTests
    {
        ...
        public void FetchTiles()
        {
            ...
            var tileSource = new MbTilesTileSource(new SQLiteConnectionString(path, false, null));
        ...
        public void SchemaGeneratedFromMbTilesWithSchemaInConstructor()
        {
            ...
            // act
            var tileSource = new MbTilesTileSource(new SQLiteConnectionString(path, false, null), new GlobalSphericalMercator("png", YAxis.TMS, null));
